...
app.config['SECURITY_PASSWORD_SALT'] = 'your-password-salt-here-change-this-in-production'
app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USERNAME'] = 'minenhlebhekane@gmail.com'  # Change this
app.config['MAIL_PASSWORD'] = 'qgiq afzv doco njul'     # Change this
app.config['MAIL_DEFAULT_SENDER'] = 'minenhlebhekane@gmail.com'  # Change this
...
def send_reset_email(recipient_email, reset_url):
    ...
    <html>
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
          <h2 style="color: #0066cc;">Alumni Nexus Password Reset</h2>
          <p>Hello,</p>
          <p>You requested to reset your password. Click the button below to proceed:</p>
          <p style="text-align: center;">
            <a href="{reset_url}" style="display: inline-block; padding: 10px 20px; background-color: #0066cc; color: white; text-decoration: none; border-radius: 5px;">Reset Password</a>
          </p>
    ...
    You requested to reset your password. Copy and paste the link below into your browser:
